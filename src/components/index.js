...
export { default as IconShare } from './IconShare/IconShare';
...
export { default as AvatarBusiness, AvatarBusinessMedium, AvatarBusinessLarge } from './AvatarBusiness/AvatarBusiness';
