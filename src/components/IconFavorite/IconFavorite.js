...
import css from './IconFavorite.css';

const IconFavorite = props => {
  const { className, rootClassName, isFavorite } = props;
  const classes = classNames(rootClassName || css.root, className);

  return (
    <svg className={classes} width="47" height="46" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485 485">
      <g
        className={isFavorite ? css.marketplaceColorStrokeFav : css.marketplaceColorStroke}        
        fillRule="evenodd"
        strokeLinecap="round"
